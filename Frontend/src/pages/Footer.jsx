                ...
                <div className='w-full max-w-7xl mx-auto'>
                    ...
                    <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
                        ...
                        <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left">
                            <a href="/">
                                GUIDENCE <span className="text-pink-500">AI</span>
                            </a>
                            ...
                            <p className='text-sm text-white/60 mt-6 max-w-sm leading-relaxed'>
                                Guidence is a growing collection of beautifully designed, production-ready Tailwind CSS UI components.
                            </p>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className='text-xs text-white/60'>© 2025 Guidence</p>
